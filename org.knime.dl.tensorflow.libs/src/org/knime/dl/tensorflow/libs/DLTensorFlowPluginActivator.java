...
public class DLTensorFlowPluginActivator extends AbstractUIPlugin {
	...
	public void start(final BundleContext context) throws Exception {
		...
		final boolean forceCPU = plugin.getPreferenceStore().getBoolean(DLTensorFlowPreferencePage.P_FORCE_CPU);
	 ...
	 */
	public static DLTensorFlowPluginActivator getDefault() {
		return plugin;
	}
	...
	private void initPreferencePageDefaults() {
		plugin.getPreferenceStore().setDefault(DLTensorFlowPreferencePage.P_FORCE_CPU,
				DLTensorFlowPreferencePage.DEFAULT_FORCE_CPU);
	}
}
