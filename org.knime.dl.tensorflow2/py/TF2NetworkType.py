...
class TF2NetworkType(DLPythonNetworkType.DLPythonNetworkType):
    ...
    def __init__(self):
        super().__init__('org.knime.dl.tensorflow2.core.TF2Network')

    @property
    def reader(self):
        from TF2Network import TF2NetworkReader
        return TF2NetworkReader()
    ...
    def wrap_model(self, model):
        from TF2Network import TF2Network
        return TF2Network(model)

    def _test_installation(self, tester):
        tester.check_lib('tensorflow', min_version="2.2.0")


# pseudo-singleton:
_instance = TF2NetworkType()
