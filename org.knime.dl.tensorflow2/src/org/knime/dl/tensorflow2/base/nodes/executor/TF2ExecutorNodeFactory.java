...
/**
 * The node factory for the TensorFlow 2 Executor.
 *
 * @author Benjamin Wilhelm, KNIME GmbH, Konstanz, Germany
 */
public class TF2ExecutorNodeFactory extends NodeFactory<DLAbstractExecutorNodeModel> {

    @Override
    public DLAbstractExecutorNodeModel createNodeModel() {
        return new TF2ExecutorNodeModel();
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new TF2ExecutorNodeDialog();
    }
}
