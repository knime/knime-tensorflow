...
public class DLTensorFlowTensorLongBuffer extends DLDefaultLongBuffer
	 ...
	 */
	public DLTensorFlowTensorLongBuffer(final long capacity) {
		super(capacity);
	}

	@Override
	public Tensor<Long> getTensor(final DLFixedTensorShape shape) {
		// TODO check if this is correct (with the shape)
		Tensor.create(shape.getShape(), LongBuffer.wrap(getStorageForReading(0, size())));
		return null;
	}
