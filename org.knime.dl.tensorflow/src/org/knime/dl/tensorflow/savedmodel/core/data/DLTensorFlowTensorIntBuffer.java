...
public class DLTensorFlowTensorIntBuffer extends DLDefaultIntBuffer
		implements DLTensorFlowTensorReadableBuffer, DLTensorFlowTensorWritableBuffer<Integer> {
	...
	@Override
	public Tensor<Integer> getTensor(final DLFixedTensorShape shape) {
		// TODO check if this is correct (with the shape)
		Tensor.create(shape.getShape(), IntBuffer.wrap(getStorageForReading(0, size())));
		return null;
	}
