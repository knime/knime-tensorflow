 ...
 */
public class TFTensorLongBuffer extends DLDefaultLongBuffer
		implements TFTensorReadableLongBuffer, TFTensorWritableLongBuffer {
	 ...
	 */
	public TFTensorLongBuffer(final long capacity) {
		super(capacity);
	}
