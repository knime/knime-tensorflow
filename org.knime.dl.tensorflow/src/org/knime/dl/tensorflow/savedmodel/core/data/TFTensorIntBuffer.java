 ...
 */
public class TFTensorIntBuffer extends DLDefaultIntBuffer
		implements TFTensorReadableIntBuffer, TFTensorWritableIntBuffer {
	 ...
	 */
	public TFTensorIntBuffer(final long capacity) {
		super(capacity);
	}
