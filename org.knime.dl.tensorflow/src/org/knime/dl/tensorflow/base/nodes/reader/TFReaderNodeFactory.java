...
public class TFReaderNodeFactory extends NodeFactory<TFReaderNodeModel> {
	...
	@Override
	public NodeView<TFReaderNodeModel> createNodeView(final int viewIndex,
			final TFReaderNodeModel nodeModel) {
		return null;
	}
