...
public class DLTensorFlowReaderNodeModel extends NodeModel {
	...
	protected PortObjectSpec[] configure(final PortObjectSpec[] inSpecs) throws InvalidSettingsException {
		...
		final DLTensorFlowSavedModel savedModel;
		try {
			savedModel = new DLTensorFlowSavedModel(m_url);
		...
		final DLTensorFlowMetaGraphDef metaGraphDefs = savedModel.getMetaGraphDefs(tags);
		...
		if (!m_advanced.getBooleanValue()) {
			...
			m_networkSpec = new DLTensorFlowSavedModelNetworkSpec(tags, inputSpecs, hiddenSpecs, outputSpecs);
		}
